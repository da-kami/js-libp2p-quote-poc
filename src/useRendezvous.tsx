...
const RENDEZVOUS_NODE_PEER_ID =
    '12D3KooWBhi3snUnzX8pTQQiRV5o6FtJXjoHT2D9dSZyJY2Z9L9E';
...
export class Rendezvous {
  ...
  public static async newInstance(): Promise<Rendezvous> {
    ...
    // Ping.mount(node); // Enable this peer to echo Ping requests
  ...
  public async discover(): Promise<rendezvous.pb.Message.IDiscoverResponse | null | undefined> {
    try {
      ...
      // data as Buffer but encode returns Buffer as well, that results in double wrapping.
