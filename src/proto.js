            ...
            pb.Message = (function() {
                ...
                Message.encode = function encode(message, writer) {
                    ...
                    if (message.register != null && Object.hasOwnProperty.call(message, "register"))
                        $root.rendezvous.pb.Message.Register.encode(message.register, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                    if (message.registerResponse != null && Object.hasOwnProperty.call(message, "registerResponse"))
                        $root.rendezvous.pb.Message.RegisterResponse.encode(message.registerResponse, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                    if (message.unregister != null && Object.hasOwnProperty.call(message, "unregister"))
                        $root.rendezvous.pb.Message.Unregister.encode(message.unregister, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                    if (message.discover != null && Object.hasOwnProperty.call(message, "discover"))
                        $root.rendezvous.pb.Message.Discover.encode(message.discover, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                    if (message.discoverResponse != null && Object.hasOwnProperty.call(message, "discoverResponse"))
                        $root.rendezvous.pb.Message.DiscoverResponse.encode(message.discoverResponse, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                    return writer;
                };
                ...
                Message.decode = function decode(reader, length) {
                    ...
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.rendezvous.pb.Message();
                    while (reader.pos < end) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            message.registerResponse = $root.rendezvous.pb.Message.RegisterResponse.decode(reader, reader.uint32());
                            break;
                        case 4:
                            message.unregister = $root.rendezvous.pb.Message.Unregister.decode(reader, reader.uint32());
                            break;
                        case 5:
                            message.discover = $root.rendezvous.pb.Message.Discover.decode(reader, reader.uint32());
                            break;
                        case 6:
                            message.discoverResponse = $root.rendezvous.pb.Message.DiscoverResponse.decode(reader, reader.uint32());
                            break;
                        default:
                ...
                Message.fromObject = function fromObject(object) {
                    ...
                    if (object.registerResponse != null) {
                        ...
                        message.registerResponse = $root.rendezvous.pb.Message.RegisterResponse.fromObject(object.registerResponse);
                    }
                    ...
                    if (object.discoverResponse != null) {
                        ...
                        message.discoverResponse = $root.rendezvous.pb.Message.DiscoverResponse.fromObject(object.discoverResponse);
                    }
                    return message;
                };
                ...
                Message.toObject = function toObject(message, options) {
                    ...
                    if (message.type != null && message.hasOwnProperty("type"))
                        object.type = options.enums === String ? $root.rendezvous.pb.Message.MessageType[message.type] : message.type;
                    if (message.register != null && message.hasOwnProperty("register"))
                        object.register = $root.rendezvous.pb.Message.Register.toObject(message.register, options);
                    if (message.registerResponse != null && message.hasOwnProperty("registerResponse"))
                        object.registerResponse = $root.rendezvous.pb.Message.RegisterResponse.toObject(message.registerResponse, options);
                    if (message.unregister != null && message.hasOwnProperty("unregister"))
                        object.unregister = $root.rendezvous.pb.Message.Unregister.toObject(message.unregister, options);
                    if (message.discover != null && message.hasOwnProperty("discover"))
                        object.discover = $root.rendezvous.pb.Message.Discover.toObject(message.discover, options);
                    if (message.discoverResponse != null && message.hasOwnProperty("discoverResponse"))
                        object.discoverResponse = $root.rendezvous.pb.Message.DiscoverResponse.toObject(message.discoverResponse, options);
                    return object;
                };
                ...
                Message.Register = (function() {
                    ...
                    Register.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.rendezvous.pb.Message.Register();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                ...
                Message.RegisterResponse = (function() {
                    ...
                    RegisterResponse.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.rendezvous.pb.Message.RegisterResponse();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                    ...
                    RegisterResponse.toObject = function toObject(message, options) {
                        ...
                        if (message.status != null && message.hasOwnProperty("status"))
                            object.status = options.enums === String ? $root.rendezvous.pb.Message.ResponseStatus[message.status] : message.status;
                        if (message.statusText != null && message.hasOwnProperty("statusText"))
                ...
                Message.Unregister = (function() {
                    ...
                    Unregister.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.rendezvous.pb.Message.Unregister();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                ...
                Message.Discover = (function() {
                    ...
                    Discover.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.rendezvous.pb.Message.Discover();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                ...
                Message.DiscoverResponse = (function() {
                    ...
                    DiscoverResponse.encode = function encode(message, writer) {
                        ...
                        if (message.registrations != null && message.registrations.length)
                            for (var i = 0; i < message.registrations.length; ++i)
                                $root.rendezvous.pb.Message.Register.encode(message.registrations[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                        if (message.cookie != null && Object.hasOwnProperty.call(message, "cookie"))
                    ...
                    DiscoverResponse.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.rendezvous.pb.Message.DiscoverResponse();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1:
                                ...
                                message.registrations.push($root.rendezvous.pb.Message.Register.decode(reader, reader.uint32()));
                                break;
                            case 2:
                                message.cookie = reader.bytes();
                                break;
                    ...
                    DiscoverResponse.fromObject = function fromObject(object) {
                        ...
                        if (object.registrations) {
                            if (!Array.isArray(object.registrations))
                                throw TypeError(".rendezvous.pb.Message.DiscoverResponse.registrations: array expected");
                            message.registrations = [];
                            for (var i = 0; i < object.registrations.length; ++i) {
                                if (typeof object.registrations[i] !== "object")
                                    throw TypeError(".rendezvous.pb.Message.DiscoverResponse.registrations: object expected");
                                message.registrations[i] = $root.rendezvous.pb.Message.Register.fromObject(object.registrations[i]);
                            }
                        }
                        if (object.cookie != null)
                            if (typeof object.cookie === "string")
                    ...
                    DiscoverResponse.toObject = function toObject(message, options) {
                        ...
                        if (message.registrations && message.registrations.length) {
                            ...
                            for (var j = 0; j < message.registrations.length; ++j)
                                object.registrations[j] = $root.rendezvous.pb.Message.Register.toObject(message.registrations[j], options);
                        }
                        if (message.cookie != null && message.hasOwnProperty("cookie"))
                            object.cookie = options.bytes === String ? $util.base64.encode(message.cookie, 0, message.cookie.length) : options.bytes === Array ? Array.prototype.slice.call(message.cookie) : message.cookie;
                        if (message.status != null && message.hasOwnProperty("status"))
